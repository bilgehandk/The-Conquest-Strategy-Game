	...
	public StartPanel() {
        ...
        btnStartButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Player player1 = new Player(player1Nick.getText(), player1cmbBox.getSelectedItem().toString());
        		Player player2 = new Player(player2Nick.getText(), player2cmbBox.getSelectedItem().toString());
